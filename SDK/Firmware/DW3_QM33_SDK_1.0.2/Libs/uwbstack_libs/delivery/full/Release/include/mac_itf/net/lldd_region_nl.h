...
#define LLDD_GET_PARAMETERS_REPLY_MAX_LEN (44)
 ...
 *	If not 0, the device will behave as an inactive device. It will participate only in blocks
 *	with an index which is a multiple of 2 to the power of inactiveExponent.
 * @LLDD_PARAM_ATTR_SHORT_ADDR:
 ...
 * @LLDD_STATS_ATTR_RX_DL_AUX_FRAMES:
 *  Number of good DL frames received in an auxiliary sub-block.
 * @LLDD_STATS_ATTR_RX_DL_AUX_BYTES:
 *  Number of good DL frames bytes received in an auxiliary sub-block,
 *  corresponding to LLDD_STATS_ATTR_RX_DL_AUX_FRAMES.
 * @LLDD_STATS_ATTR_RX_DL_AUX_ERRORS:
 *  Number of DL frames received with error in an auxiliary sub-block.
