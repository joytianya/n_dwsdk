 ...
 */
static inline void uwbmac_parser_init_msg(struct uwbmac_msg *msg, void *payload, int length)
{
 ...
 */
enum qerr uwbmac_parser_read(struct uwbmac_msg *msg, struct uwbmac_parser_element elements[],
			     int tag_max);
 ...
 * Return: QERR_SUCCESS or error.
 */
enum qerr uwbmac_parser_read_array(struct uwbmac_msg *msg, struct uwbmac_parser_element elements[],
				   int tag_max, void *entry, int n,
				   struct uwbmac_parser_read_array_info *info, bool *keep_going);

/**
 * uwbmac_parser_init_nested_loop() - Init internal loop data for nested
 * iteration
 * @msg: Message to parse.
 * @info: Internal loop data.
 *
 * This call is once before looping on each element with
 * uwbmac_parser_next_nested_loop_element.
 *
 * Return: QERR_SUCCESS or error.
 */
enum qerr uwbmac_parser_init_nested_loop(struct uwbmac_msg *msg,
					 struct uwbmac_parser_read_array_info *info);

/**
 * uwbmac_parser_next_nested_loop_element() - Init nested with the next nested
 * element
 * @msg: Message to parse.
 ...
 * @keep_going: Whether there are elements left in the array.
 *
 * If keep_going is false, you've reached the end of the nested elements and
 ...
 * Return: QERR_SUCCESS or error.
 */
enum qerr uwbmac_parser_next_nested_loop_element(struct uwbmac_msg *msg, struct uwbmac_msg *nested,
						 struct uwbmac_parser_read_array_info *info,
						 bool *keep_going);
 ...
 */
static inline bool uwbmac_parser_is_present(struct uwbmac_parser_element elements[], int tag)
{
 ...
 */
static inline void uwbmac_parser_add(struct uwbmac_parser_element elements[], int tag,
				     enum uwbmac_payload_type type, void *data, int *rlength,
				     int length, bool mandatory)
{
 ...
 * @tag: Tag in the payload.
 */
static inline void uwbmac_parser_add_none(struct uwbmac_parser_element elements[], int tag)
{
	uwbmac_parser_add(elements, tag, UWBMAC_PAYLOAD_TYPE_NONE, NULL, NULL, 0, false);
}
 ...
 * @mandatory: Whether the element is mandatory in the message.
 */
static inline void uwbmac_parser_add_flag(struct uwbmac_parser_element elements[], int tag,
					  bool *data, bool mandatory)
{
	*data = false;
	uwbmac_parser_add(elements, tag, UWBMAC_PAYLOAD_TYPE_FLAG, data, NULL, sizeof(*data),
			  mandatory);
}
 ...
 * @mandatory: Whether the element is mandatory in the message.
 */
static inline void uwbmac_parser_add_bool(struct uwbmac_parser_element elements[], int tag,
					  bool *data, bool mandatory)
{
	uwbmac_parser_add(elements, tag, UWBMAC_PAYLOAD_TYPE_BOOL, data, NULL, sizeof(*data),
			  mandatory);
}
 ...
 * @mandatory: Whether the element is mandatory in the message.
 */
static inline void uwbmac_parser_add_s8(struct uwbmac_parser_element elements[], int tag,
					int8_t *data, bool mandatory)
{
	uwbmac_parser_add(elements, tag, UWBMAC_PAYLOAD_TYPE_S8, data, NULL, sizeof(*data),
			  mandatory);
}
 ...
 * @mandatory: Whether the element is mandatory in the message.
 */
static inline void uwbmac_parser_add_s16(struct uwbmac_parser_element elements[], int tag,
					 int16_t *data, bool mandatory)
{
	uwbmac_parser_add(elements, tag, UWBMAC_PAYLOAD_TYPE_S16, data, NULL, sizeof(*data),
			  mandatory);
}
 ...
 * @mandatory: Whether the element is mandatory in the message.
 */
static inline void uwbmac_parser_add_s32(struct uwbmac_parser_element elements[], int tag,
					 int32_t *data, bool mandatory)
{
	uwbmac_parser_add(elements, tag, UWBMAC_PAYLOAD_TYPE_S32, data, NULL, sizeof(*data),
			  mandatory);
}
 ...
 * @mandatory: Whether the element is mandatory in the message.
 */
static inline void uwbmac_parser_add_s64(struct uwbmac_parser_element elements[], int tag,
					 int64_t *data, bool mandatory)
{
	uwbmac_parser_add(elements, tag, UWBMAC_PAYLOAD_TYPE_S64, data, NULL, sizeof(*data),
			  mandatory);
}
 ...
 * @mandatory: Whether the element is mandatory in the message.
 */
static inline void uwbmac_parser_add_u8(struct uwbmac_parser_element elements[], int tag,
					uint8_t *data, bool mandatory)
{
	uwbmac_parser_add(elements, tag, UWBMAC_PAYLOAD_TYPE_U8, data, NULL, sizeof(*data),
			  mandatory);
}
 ...
 * @mandatory: Whether the element is mandatory in the message.
 */
static inline void uwbmac_parser_add_u16(struct uwbmac_parser_element elements[], int tag,
					 uint16_t *data, bool mandatory)
{
	uwbmac_parser_add(elements, tag, UWBMAC_PAYLOAD_TYPE_U16, data, NULL, sizeof(*data),
			  mandatory);
}
 ...
 * @mandatory: Whether the element is mandatory in the message.
 */
static inline void uwbmac_parser_add_u32(struct uwbmac_parser_element elements[], int tag,
					 uint32_t *data, bool mandatory)
{
	uwbmac_parser_add(elements, tag, UWBMAC_PAYLOAD_TYPE_U32, data, NULL, sizeof(*data),
			  mandatory);
}
 ...
 * @mandatory: Whether the element is mandatory in the message.
 */
static inline void uwbmac_parser_add_u64(struct uwbmac_parser_element elements[], int tag,
					 uint64_t *data, bool mandatory)
{
	uwbmac_parser_add(elements, tag, UWBMAC_PAYLOAD_TYPE_U64, data, NULL, sizeof(*data),
			  mandatory);
}
 ...
 */
static inline void uwbmac_parser_add_string(struct uwbmac_parser_element elements[], int tag,
					    char *data, int max_length, bool mandatory)
{
	uwbmac_parser_add(elements, tag, UWBMAC_PAYLOAD_TYPE_STRING, data, NULL, max_length,
			  mandatory);
}
 ...
 */
static inline void uwbmac_parser_add_binary(struct uwbmac_parser_element elements[], int tag,
					    void *data, int *length, int max_length, bool mandatory)
{
	uwbmac_parser_add(elements, tag, UWBMAC_PAYLOAD_TYPE_BINARY, data, length, max_length,
			  mandatory);
}
 ...
 * @mandatory: Whether the element is mandatory in the message.
 */
static inline void uwbmac_parser_add_nested(struct uwbmac_parser_element elements[], int tag,
					    struct uwbmac_msg *nested, bool mandatory)
{
	uwbmac_parser_add(elements, tag, UWBMAC_PAYLOAD_TYPE_NESTED, nested, NULL, 0, mandatory);
}
 ...
 * @tag: output value
 * @is_nested: output value telling whether data is a nested message to binary
 * data.
 ...
 *
 * Return: status QERR_SUCCESS or QERR_EINVAL.
 */
enum qerr uwbmac_msg_read_tag(struct uwbmac_msg *msg, int *tag, bool *is_nested, int *rem);
 ...
 * Return: status QERR_SUCCESS or QERR_EINVAL.
 */
enum qerr uwbmac_msg_read_nested(struct uwbmac_msg *msg, struct uwbmac_msg *nested, int *rem);
